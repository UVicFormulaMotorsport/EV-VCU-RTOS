\doxysubsection{x\+Message\+Buffer\+Receive}
...
size\+\_\+t \doxylink{message__buffer_8h_af12a227ba511a95cbea5aa81c7f3ba12}{x\+Message\+Buffer\+Receive( Message\+Buffer\+Handle\+\_\+t x\+Message\+Buffer,                               void \texorpdfstring{$\ast$}{*}pv\+Rx\+Data,                               size\+\_\+t x\+Buffer\+Length\+Bytes,                               Tick\+Type\+\_\+t x\+Ticks\+To\+Wait )};
...
void v\+AFunction( Message\+Buffer\+\_\+t x\+Message\+Buffer ) \{ uint8\+\_\+t uc\+Rx\+Data\mbox{[} 20 \mbox{]}; size\+\_\+t x\+Received\+Bytes; const Tick\+Type\+\_\+t x\+Block\+Time = \doxylink{projdefs_8h_a353d0f62b82a402cb3db63706c81ec3f}{pd\+MS\+\_\+\+TO\+\_\+\+TICKS( 20 )};

Receive the next message from the message buffer. Wait in the Blocked state (so not using any CPU processing time) for a maximum of 100ms for a message to become available. x\+Received\+Bytes = x\+Message\+Buffer\+Receive( x\+Message\+Buffer, ( void \texorpdfstring{$\ast$}{*} ) uc\+Rx\+Data, sizeof( uc\+Rx\+Data ), x\+Block\+Time );
